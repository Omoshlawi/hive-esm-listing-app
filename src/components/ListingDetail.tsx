  ...
  return (
    <Stack gap="xl">
            ...
            <Stack gap="md">
              <Group justify="space-between" align="flex-start">
                <Stack gap="xs">
                  <Group gap="xs">
                    <Badge
                      variant="filled"
                      color={getStatusColor(mockListing.status)}
                      size="lg"
                    >
              ...
              <Group gap="xs">
                ...
                <Text size="sm" color="dimmed">
                  {mockListing.views.toLocaleString()} views
                </Text>
                <Text size="sm" color="dimmed">
                  •
                </Text>
                ...
                <Text size="sm" color="dimmed">
                  Listed {new Date(mockListing.listedDate).toLocaleDateString()}
                </Text>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            ...
            >
              <Stack gap="md">
                ...
                <Group gap="xs">
                  <Avatar src={mockListing.contactPerson.avatar} size="sm" />
                  <div style={{ flex: 1 }}>
                    <Text size="sm" fw={500}>
                  ...
                  <Group gap="xs">
                    {[...Array(5)].map((_, i) => (
                      <IconStar
                        ...
                        size={12}
                        fill={
                          i < Math.floor(mockListing.contactPerson.rating)
                            ? primaryColor[6]
                            : "none"
                        }
      ...
      >
        <Stack gap="md">
          <Group gap="md">
            <Avatar src={mockListing.contactPerson.avatar} size="lg" />
            <div>
              <Text fw={500} size="lg">
                {mockListing.contactPerson.name}
              </Text>
              <Text color="dimmed">{mockListing.contactPerson.title}</Text>
              <Group gap="xs" mt="xs">
                {[...Array(5)].map((_, i) => (
                  <IconStar
                    key={i}
                ...
                <Text size="sm" color="dimmed">
                  ...
                  {mockListing.contactPerson.totalSales} sales
                </Text>
              </Group>
            </div>
          </Group>
          ...
          <Stack gap="xs">
            <Button
              ...
              leftSection={<IconPhone size={16} />}
              component="a"
              href={`tel:${mockListing.contactPerson.phone}`}
            >
              Call {mockListing.contactPerson.phone}
            </Button>
            <Button
              fullWidth
              variant="outline"
              ...
              component="a"
              href={`mailto:${mockListing.contactPerson.email}`}
            >
              Email {mockListing.contactPerson.email}
            </Button>
            <Button
              fullWidth
              variant="outline"
